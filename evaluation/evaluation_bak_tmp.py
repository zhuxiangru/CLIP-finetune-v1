...
def main():
    ...
    avg_len = total_len/total_len_count
    print ("avg_len=", avg_len)
    
    avg_pos_len = total_pos_len/pos_label_count
    print ("avg_pos_len=", avg_pos_len)
